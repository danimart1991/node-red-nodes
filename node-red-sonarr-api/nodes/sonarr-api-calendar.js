module.exports = function(RED) {
    ...
    function SonarrApiCalendarNode(config) {
        ...
        if (!credentials) {
            ...
            node.on('input', function(msg) {
                ...
                let nodeType = 'sonarr-api-calendar';
                ...
                try {
                    ...
                    let episodeFile = RED.util.evaluateNodeProperty(config.include_episode_file, config.include_episode_file_type || 'option', node, msg);
                    let episodeImages = RED.util.evaluateNodeProperty(config.include_episode_images, config.include_episode_images_type || 'option', node, msg);
                    let includeSeries = RED.util.evaluateNodeProperty(config.include_series, config.include_series_type || 'option', node, msg);
                    ...
                    url.append('includeEpisodeFile', episodeFile);
                    url.append('includeEpisodeImages', episodeImages);
                    url.append('includeSeries', includeSeries);
    ...
    RED.nodes.registerType('sonarr-api-calendar', SonarrApiCalendarNode);
};
